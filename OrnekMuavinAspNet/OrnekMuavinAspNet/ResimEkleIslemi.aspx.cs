...
{
    public partial class ResimEkleIslemi : System.Web.UI.Page
    {
        ...
        protected void btnekle_Click(object sender, EventArgs e)
        {
            ...
            {
                var resimadi = Muavin.ResimEkle(resim.PostedFile.InputStream, resim.PostedFile.ContentType.Split('/')[1], Server.MapPath("/images/"), true, 1000);
